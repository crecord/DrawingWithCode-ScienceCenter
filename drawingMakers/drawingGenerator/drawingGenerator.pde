// this is an example for Drawing with Code for the Ellis School
// This sketch radomly creates drawings every time you click it. 

// this runs once at the beginning just to set up
void setup() {
  size (600, 600);
  mouseClicked();
}

// drawing loop needs to be here for the mouse clicked function to work.
void draw() {
